...
\begin{itemize}
\item la procedura di merging implementata utilizza come semplificazione regole riferite ad \textbf{EveryOne}; questo perché il progetto MOSAICO ha il suo focus sui dati;
...
Il primo componente della pipeline si occupa di estrarre le informazioni di rilievo dalle policy in ingresso mentre il componente in coda ha il roulo di produttore di documenti conformi ad ODRL.

...
\begin{figure}[htp]
\centering
\includegraphics[scale=1]{/home/oldem/IdeaProjects/actionTree/File documento di tesi/immagini/arch_gen.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.00]{/home/oldem/IdeaProjects/actionTree/File documento di tesi/immagini/enumAction.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.60]{/home/oldem/IdeaProjects/actionTree/File documento di tesi/immagini/imgCompRule.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.50]{/home/oldem/IdeaProjects/actionTree/File documento di tesi/immagini/propagationPerm.pdf}
\caption{Esempio di propagazione di un permesso, con azione figlia proibita}
\label{examplePerm}
\end{figure}
\begin{figure}[htp]
\centering
\includegraphics[scale=.50]{/home/oldem/IdeaProjects/actionTree/File documento di tesi/immagini/propagationProParent.pdf}
